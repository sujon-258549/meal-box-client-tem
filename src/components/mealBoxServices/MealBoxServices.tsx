    ...
    <div className="min-h-screen max-w-5xl mx-auto">
      <main className=" mx-auto  md:px-0 px-4 py-12">
        ...
        <section className="text-center mb-16">
          <h1 className="text-4xl font-bold mb-4">Meal Box Services</h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Delicious, nutritious meals delivered to your door. Choose from our
            variety of plans tailored to your dietary needs and lifestyle.
          </p>
        </section>
